...
export default function LoginScreen({ navigation }) {
  ...
  const handleOAuth = (provider) => {
    Alert.alert('OAuth', `${provider} login coming soon`);
  };
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.logoText}>TimeWise</Text>
            <Text style={styles.subtitle}>Smart Calendar & Task Manager</Text>
          </View>
          ...
          <View style={styles.formContainer}>
            ...
            >
              <Ionicons name="logo-microsoft" size={20} color="#666" />
